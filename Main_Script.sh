...
wget http://$web_url/ubuntu/dists/$distro_name/$repo_name/binary-amd64/Packages.gz -P "$backup_directory/$distro_name/$repo_name/"
wget http://$web_url/ubuntu/dists/$distro_name/$repo_name/binary-i386/Packages.gz -P "$backup_directory/$distro_name/$repo_name/"
gunzip "$backup_directory/$distro_name/$repo_name/Packages.gz"
grep "Filename" "$backup_directory/$distro_name/$repo_name/Packages" | awk '{print "http://$web_url/ubuntu/"$2}' > "$backup_directory/$distro_name/$repo_name/download_list.temp"
